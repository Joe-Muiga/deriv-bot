...
# ── TRADE / COMPAT ALIASES ────────────────────────────────────
ALL_TRADE_SYMBOLS    = ALL_SYMBOLS
VOLATILITY_STANDARD  = VOLATILITY_STANDARD
VOLATILITY_1S        = [s for s in VOLATILITY_1S if "1HZ" in s]
JUMP                 = []
DRIFT                = []
STEP                 = STEP
RANGE_BREAK          = RANGE_BREAK
BOOM_CRASH           = BOOM_CRASH
MULTIPLIER_MAP       = MULTIPLIER_MAP
STOP_LOSS_MAP        = STOP_LOSS_MAP
DEFAULT_MULTIPLIER   = DEFAULT_MULTIPLIER
DEFAULT_STOP_LOSS_PCT = DEFAULT_STOP_LOSS_PCT
TAKE_PROFIT_RATIO    = TAKE_PROFIT_RATIO
MAX_TRADE_OPEN_MINS  = MAX_TRADE_OPEN_MINS
CHECK_TRADE_MINS     = CHECK_TRADE_MINS
PLS_WIN_THRESHOLDS   = PLS_WIN_THRESHOLDS
PLS_WIN_MULTIPLIERS  = PLS_WIN_MULTIPLIERS
PLS_WIN_EXTRA_SLOTS  = PLS_WIN_EXTRA_SLOTS
