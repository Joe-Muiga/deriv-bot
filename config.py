...
PROFIT_CYCLE_TARGET_PCT       = float(os.environ.get("PROFIT_CYCLE_TARGET_PCT", "10"))
PROFIT_CYCLE_COOLDOWN_MINUTES = float(os.environ.get("PROFIT_CYCLE_COOLDOWN_MINUTES", "11"))
...
REDEPLOY_INTERVAL_HOURS = 6 / 60    # 5 minutes, expressed as hours since
